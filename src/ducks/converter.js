import { createAction, readFromLocalStorige, writeToLocalStorige } from "../utils";
import api from '../api';
...
export const setChangeableCurrencyCode = code => {
    writeToLocalStorige('changeable_currency_code', code);

    return createAction(SET_CHANGEABLE_CURRENCY_CODE, { changeableCurrencyCode: code })
};

export const setSelectCurrencyCode = code => {
    writeToLocalStorige('select_currency_code', code);

    return createAction(SET_SELECT_CURRENCY_CODE, { selectCurrencyCode: code })
};
...
const initialState = {
    list: [],
    isLoading: false,
    changeableCurrencyCode: readFromLocalStorige('changeable_currency_code') || DEFAULT_CHANGEABLE_CURRENCY_CODE,
    selectCurrencyCode: readFromLocalStorige('select_currency_code') || DEFAULT_SELECT_CURRENCY_CODE
}
...
export const getChangeableCurrencyCode = state => state.converter.changeableCurrencyCode

export const getSelectCurrencyCode = state => state.converter.selectCurrencyCode
